data_set = ['Apple pie', 'Baby back ribs', 'Baklava', 
            ...
            'Gnocchi', 'Greek salad', 'Grilled cheese sandwich', 'Grilled salmon', 
            ...
            'Mussels', 'Nachos', 'Omelette', 'Onion rings', 'Oysters', 'Pad thai', 
            'Paella', 'Pancakes', 'Panna cotta', 'Peking duck', 'Pho', 'Pizza', 
            'Pork chop', 'Poutine', 'Prime rib', 'Pulled pork sandwich', 'Ramen', 
